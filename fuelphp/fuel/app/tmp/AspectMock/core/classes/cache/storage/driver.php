...
abstract class Cache_Storage_Driver
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($identifier, $config), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($identifier), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($contents, $expiration, $dependencies), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($use_expiration), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! $this->_get())
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($callback, $args, $expiration, $dependencies), false)) !== __AM_CONTINUE__) return $__am_res; 
		try
		{
			$this->get();
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($contents, $handler), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($handler), false)) !== __AM_CONTINUE__) return $__am_res; 
		$this->handler_object = null;
