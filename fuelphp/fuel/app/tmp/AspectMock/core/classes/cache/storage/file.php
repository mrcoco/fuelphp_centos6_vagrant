...
class Cache_Storage_File extends \Cache_Storage_Driver
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($section), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($identifier), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($payload), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $value), false)) !== __AM_CONTINUE__) return $__am_res; 
		switch ($name)
		{
			case 'cache_id':
