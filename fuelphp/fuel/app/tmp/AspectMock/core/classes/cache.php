...
class Cache
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($identifier, $config), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($identifier, $contents, $expiration, $dependencies), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($identifier, $callback, $args, $expiration, $dependencies), true)) !== __AM_CONTINUE__) return $__am_res; 
		$cache = static::forge($identifier);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($identifier, $use_expiration), true)) !== __AM_CONTINUE__) return $__am_res; 
		$cache = static::forge($identifier);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($section, $driver), true)) !== __AM_CONTINUE__) return $__am_res; 
