...
class File
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $config, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($basepath, $name, $contents, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($basepath, $name, $chmod, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
		$basepath	= rtrim(static::instance($area)->get_path($basepath), '\\/').DS;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $as_string, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $depth, $filter, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $type, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
		$path = static::instance($area)->get_path($path);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $new_path, $source_area, $target_area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $link_path, $is_file, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
		$path      = rtrim(static::instance($area)->get_path($path), '\\/');
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $recursive, $delete_top, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
		$path = rtrim(static::instance($area)->get_path($path), '\\/').DS;
		if ( ! is_dir($path))
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $lock, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_string($path))
		{
			$path = static::instance($area)->get_path($path);
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($resource, $area), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $name, $mime, $area, $delete, $disposition), true)) !== __AM_CONTINUE__) return $__am_res; 
