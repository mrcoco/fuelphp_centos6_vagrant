...
class Format
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($data, $from_type, $param), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $from_type, $param), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $structure, $basenode, $use_cdata, $bool_representation), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($data == null)
		{
			$data = $this->_data;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $delimiter, $enclose_numbers, $headings), false)) !== __AM_CONTINUE__) return $__am_res; 
		// csv format settings
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $pretty), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($data === null)
		{
			$data = $this->_data;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $pretty, $callback), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($string, $recursive), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($string, $no_headings), false)) !== __AM_CONTINUE__) return $__am_res; 
		$data = array();
